    ...
    module DeprecatedMethods
      ...
      def update_all_with_deprecated_options(updates, conditions = nil, options = {})
        ...
        if conditions
          ...
          ActiveSupport::Deprecation.warn(
            ...
            "Item.update_all(..., color: 'red').", clean_caller
          )
        end
        ...
        if options.present?
          ...
          ActiveSupport::Deprecation.warn(
            ...
            "Please use e.g. Post.limit(1).order(:foo).update_all instead.", clean_caller
          )
        end
      ...
      def find_in_batches(options = {}, &block)
        if (finder_options = options.except(:start, :batch_size)).present?
          ActiveSupport::Deprecation.warn(
            ...
            "a scope and then call find_in_batches on it instead.", clean_caller
          )
      ...
      def calculate(operation, column_name, options = {})
        if options.except(:distinct).present?
          ActiveSupport::Deprecation.warn(
            ...
            "a scope and then call calculate on it instead.", clean_caller
          )
        ...
        if options.present?
          ...
          when :first, :last, :all
            ...
            ActiveSupport::Deprecation.warn(
              ...
              "and then call #find on it.", clean_caller
            )
          ...
          when :first, :last, :all
            ActiveSupport::Deprecation.warn(
              "Calling #find(#{finder.inspect}) is deprecated. Please call " \
              "##{finder} directly instead.", clean_caller
            )
        ...
        if args.empty?
          ...
          if args.first.kind_of?(Integer) || (loaded? && !args.first.kind_of?(Hash))
            ...
            ActiveSupport::Deprecation.warn(
              ...
              "a scope and then call #first on it instead.", clean_caller
            )
        ...
        if args.empty?
          ...
          if args.first.kind_of?(Integer) || (loaded? && !args.first.kind_of?(Hash))
            ...
            ActiveSupport::Deprecation.warn(
              ...
              "a scope and then call #last on it instead.", clean_caller
            )
      ...
      def all(*args)
        ActiveSupport::Deprecation.warn(
          ...
          "`Post.where(published: true).to_a`).", clean_caller
        )
